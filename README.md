...
When `ACCOUNT_ACCESS_DESIRED_COUNT` or `ORGANIZATION_DESIRED_COUNT` is greater than `0`, `PRIVATE_SUBNET_IDS` becomes required. The stack uses those subnets for the dedicated service databases and Redis.
