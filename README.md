...
- The current EC2 proof keeps both hosts on x86_64 instance types by default because the live service images are still `linux/amd64` only. Do not switch the proof lane to Graviton until the image fleet is published as multi-arch.
